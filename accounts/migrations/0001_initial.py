# Generated by Django 3.2.16 on 2022-12-15 11:30
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(default='name yet to be updated', max_length=150)),
                ('bio', models.TextField(default='bio yet to be updated')),
                ('image', models.ImageField(default='profile_pics/no_image.png', upload_to='profile_pics')),
